                ...
                <div class="max-w-3xl mx-auto bg-white border-2 border-gray-200 p-8 rounded-xl hover:border-blue-500 hover:shadow-xl transition-all">
                    <ul class="space-y-4 text-gray-600">
                        <li class="flex items-start gap-3">
                            ...
                            <span>Utrzymanie backendu i naprawa błędów</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-blue-600 font-bold mt-1">•</span>
                            <span>Tworzenie REST API</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-blue-600 font-bold mt-1">•</span>
                            <span>Integracje API</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-blue-600 font-bold mt-1">•</span>
                            <span>Refaktoring istniejących systemów PHP/Laravel</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-blue-600 font-bold mt-1">•</span>
                            <span>Projektowanie baz danych i optymalizacja</span>
                        </li>
                    </ul>
                    <p class="mt-8 text-center text-gray-600 italic">Dostępny do pracy zdalnej na umowę lub freelance.</p>
                </div>
            </div>
        </div>
    </section>
